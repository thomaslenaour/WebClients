...
describe('Import LastPass csv', () => {
    ...
    it('transforms lastpass csv into ImportPayload', async () => {
        ...
        expect(loginItem3.content.totpUri).toEqual('otpauth://totp/Twitter?secret=base32secret');
        ...
        expect(loginItem4.content.totpUri).toEqual('otpauth://totp/fb.com?secret=base32secret');
    });
});
