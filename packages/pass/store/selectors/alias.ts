...
export const selectAliasByAliasEmail = createSelector(
    [selectItemsByType('alias'), (_: State, aliasEmail: string) => aliasEmail],
    (aliasItems, aliasEmail) => aliasItems.find((item) => item.aliasEmail! === aliasEmail)
);
