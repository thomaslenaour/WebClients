...
export const AliasPreview: VFC<{
    ...
    return (
        <div className={clsx(['flex flex-column flex-align-items-center mb-3', className])}>
            <div className="mb-4 color-weak">{c('Info').t`You are about to create:`}</div>
            <div className="w100 text-center">
                {loading ? (
                    <div className="w100 extension-skeleton extension-skeleton--alias-preview" />
                ) : (
                    <MiddleEllipsis
