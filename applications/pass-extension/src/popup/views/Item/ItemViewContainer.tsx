...
export const ItemViewContainer: VFC = () => {
    ...
    const itemFromOptimisticId = useSelector(selectItemIdByOptimisticId(itemId));
    ...
    useEffect(() => {
        if (itemFromOptimisticId) {
            selectItem(itemFromOptimisticId.shareId, itemFromOptimisticId.itemId);
        }
    }, [itemFromOptimisticId]);
